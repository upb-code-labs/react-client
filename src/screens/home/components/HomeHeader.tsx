...
export const HomeHeader = () => {
  ...
  return (
    <header className={`relative overflow-hidden rounded-3xl ${styles.hero}`}>
        ...
        <div className="grid place-items-center">
          <div className="flex max-w-prose flex-col items-center gap-4 text-pretty text-center md:items-start md:text-start">
            ...
            <p className="text-xl leading-relaxed text-black/75">
              With Code Labs, students receive instant feedback, while educators
              enjoy simplified grading and monitoring in coding activities.
            </p>
            <div>
              {user ? (
                <Link
